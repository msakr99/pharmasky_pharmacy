// nextjs-components/components/NotificationBadge.tsx
// ═══════════════════════════════════════════════════════════════════
// مكون لعرض شارة الإشعارات غير المقروءة
// ═══════════════════════════════════════════════════════════════════
...
export const NotificationBadge: React.FC<NotificationBadgeProps> = ({
  ...
  // ═══════════════════════════════════════════════════════════════
  // جلب البيانات عند التحميل والتحديث الدوري
  // ═══════════════════════════════════════════════════════════════
  useEffect(() => {
    if (authToken) {
      fetchUnreadCount();
  ...
  return (
    <div className={`relative ${className}`} onClick={handleClick}>
      {/* أيقونة الإشعارات */}
      <svg
        className="w-6 h-6 text-gray-600 dark:text-gray-400 hover:text-blue-600 transition-colors"
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
      >
