...
export default function SkyRepPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 flex flex-col">
      ...
      {/* Main Chat Container */}
      <div className="flex-1 flex flex-col max-w-4xl mx-auto w-full pt-4 sm:pt-8">
        {/* Messages Area */}
        <div className="flex-1 overflow-y-auto px-2 sm:px-4 py-4 sm:py-6" style={{ maxHeight: 'calc(100vh - 180px)' }}>
        ...
        <div className="sticky bottom-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 px-2 sm:px-4 py-3 sm:py-4">
          <div className="max-w-3xl mx-auto">
            {/* Centered Question Text */}
            {messages.length === 0 && (
              <div className="text-center mb-6 sm:mb-8 mt-12 sm:mt-20">
                <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-gray-800 dark:text-gray-200 mb-2">
            ...
            {/* Footer Note */}
            <p className="text-center text-xs text-gray-500 dark:text-gray-500 mt-1 sm:mt-2 px-2">
